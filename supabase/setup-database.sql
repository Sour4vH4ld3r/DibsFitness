-- Dibs Fitness Database Setup - Complete
-- Run this script in your Supabase SQL Editor to set up the entire database
-- This script will create all necessary tables, policies, and sample data
...
BEGIN
  ...
  RAISE NOTICE 'Tables created: profiles, members, plans, sessions, payments, invoices';
  RAISE NOTICE 'All RLS policies and triggers have been applied';
  RAISE NOTICE 'You can now use the Dibs Fitness application';
END $$;
...
AND tablename IN ('profiles', 'members', 'plans', 'sessions', 'payments', 'invoices')
ORDER BY tablename;